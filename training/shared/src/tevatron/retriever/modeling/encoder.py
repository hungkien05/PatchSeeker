...
class EncoderModel(nn.Module):
    ...
    def gradient_checkpointing_enable(self, **kwargs):
        # Auto-detect: causal LM (LLaMA/Qwen) has .model, encoder-decoder (T5/CR) does not
    ...
    def build(
        ...
        base_model = cls.TRANSFORMER_CLS.from_pretrained(model_args.model_name_or_path, **load_kwargs)
