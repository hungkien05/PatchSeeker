...
class ModelArguments:
    ...
    model_pickle_path: str = field(
        default=None,
        metadata={"help": "Path to pickle file that contains model and tokenizer"}
    )
...
class DataArguments:
    ...
    raw_file_path: str = field(
        default=None, metadata={"help": "Path to file that needs to be encoded"}
    )
