...
cve_corpus_dir="test_all/cve_corpus_split2"
# Create output directories if they don't exist
base_output_dir="beir_embedding_cve_test_qwen8b"
...
model_pickle_dir="pickle/qwen8b"
...
for cve_file in ${cve_corpus_dir}/*.json; do
    ...
    CUDA_VISIBLE_DEVICES=3 python repllama/encode_cve.py \
      --output_dir=temp \
