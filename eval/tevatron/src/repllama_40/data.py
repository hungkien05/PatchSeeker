...
class HFQueryDataset:
    def __init__(self, tokenizer: PreTrainedTokenizer, data_args: DataArguments, cache_dir: str):
        ...
        json_file_path = "/home/huuhungn/tuanna/tevatron_v1/tevatron/src/data_eval_437cve/cve_queries.json"
...
class HFCorpusDataset:
    def __init__(self, tokenizer: PreTrainedTokenizer, data_args: DataArguments, cache_dir: str):
        # Đường dẫn tới file JSON và file mã hóa
        json_file_path = "/home/huuhungn/tuanna/tevatron_v1/tevatron/src/data_eval_437cve/cve_corpus.json"
