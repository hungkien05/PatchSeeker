...
# ckpt="/mnt/moon-data/hung/neptune_data/tuanna/retrieval_llama3_8b/checkpoint-239"
...
base_output_dir="beir_embedding_cve_test_0806_llama3"
...
model_pickle_dir="pickle/llama3"
...
for cve_file in ${cve_corpus_dir}/*.json; do
    ...
    CUDA_VISIBLE_DEVICES=6 python repllama/encode_cve.py \
      --output_dir=temp \
